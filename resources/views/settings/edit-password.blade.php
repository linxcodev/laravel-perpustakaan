                  ...
                  <form action="{{ route('password.update') }}" method="post">
                    ...
                    <form action="{{ route('password.update') }}" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input id="new_password" type="password" class="form-control {{ $errors->has('new_password') ?
                          'is-invalid' : '' }}" name="new_password">
                      ...
                      <form action="{{ route('password.update') }}" method="post">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input id="new_password_confirmation" type="password" class="form-control {{ $errors->has('new_password_confirmation') ?
                            'is-invalid' : '' }}" name="new_password_confirmation">
